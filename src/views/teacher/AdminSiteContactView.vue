...
<style scoped>.page{max-width:720px;margin:0 auto;padding:32px 24px}.eyebrow{font-size:11px;font-weight:700;letter-spacing:.1em;color:var(--practiq-violet);text-transform:uppercase}h1{margin:6px 0;color:var(--text-heading)}header p:last-child{color:var(--text-secondary)}form{display:grid;gap:18px;margin-top:30px;padding:26px;border:1px solid var(--surface-border);border-radius:14px;background:var(--surface-card)}label{display:grid;gap:7px;font-weight:600}input{padding:12px;border:1px solid var(--surface-border);border-radius:8px;font:inherit}button{justify-self:start;padding:12px 18px;border:0;border-radius:8px;background:var(--practiq-violet);color:#fff;font-weight:700;cursor:pointer}button:disabled{opacity:.6}@media(max-width:600px){.page{padding:20px 16px 32px}h1{font-size:1.65rem;line-height:1.14}header p:last-child{margin-bottom:0;font-size:.92rem;line-height:1.5}form{gap:16px;margin-top:22px;padding:18px 16px;border-radius:12px}input{min-height:44px;font-size:16px}button{width:100%;min-height:44px;justify-self:stretch}}</style>
